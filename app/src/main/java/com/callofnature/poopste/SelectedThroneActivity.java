...
public class SelectedThroneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_selected_nearby);
        ...
        mViewPager = (ViewPager) findViewById(R.id.viewpager_nearby);
